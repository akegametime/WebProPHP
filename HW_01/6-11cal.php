...
if ($total >= 80) echo  "<img src='Pic/A.jpg'  >";
elseif ($total >= 70) echo  "<a ><img src='Pic/B.jpg'  />";
elseif ($total >= 60) echo  "<a ><img src='Pic/C.jpg'  />";
elseif ($total >= 50) echo  "<img src='Pic/D.jpg'  />";
else echo "<img src='Pic/F.jpg'  />";



echo "<br>";
echo "<a href='6-11.php'> <big>Back </big></a>";
?>
